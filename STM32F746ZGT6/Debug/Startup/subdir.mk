...
Startup/%.o: ../Startup/%.s Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m7 -g3 -DDEBUG -c -I"D:/STM32CubeIDE/workspace_1.11.2/STM32F746ZGT6/Drivers/CMSIS/Include" -I"D:/STM32CubeIDE/workspace_1.11.2/STM32F746ZGT6/Drivers/CMSIS/Device/ST/STM32F7xx/Include" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
