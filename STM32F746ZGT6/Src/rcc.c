 ...
 *
 * For MCU working at 32 MHz you need to uncomment lines: 60-61, 76, 88-91, 125;
 * and comment lines: 49, 54-56, 71, 82-85, 109-112, 119, 121;
 *
 * For MCU working at 216 MHz you need to uncomment lines: 49, 54-56, 71, 82-85, 109-112, 119, 121;
